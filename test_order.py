...
def test_new_baixar_estoque():
    ...
    pedido = Pedido(1, cliente, datetime.today)
    pedido_produto = PedidoProduto()
    pedido_produto.adicionar_produto(product1, 35)
    pedido.adicionar_produto_pedido(pedido_produto)

    product1.baixar_estoque(35)

    assert product1.estoque == 30


def baixar_estoque():
    product1 = Produto(1, "Arroz", 50, 100)
    n = 50

    product1.baixar_estoque(n)

    assert product1.baixar_estoque(50)    
